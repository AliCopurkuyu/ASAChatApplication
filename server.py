...
# Client info dictionary to store usernames
client_info = {}
    ...
    while True:
        try:
            ...
            if not received_data:
                username = client_info.get(client_address, str(client_address))
    ...
    while True:
        try:
            ...
            if received_data:
                ...
                if received_data.decode(hosts.unicode) == 'JOIN':
